            ...
            <div class="semestre-card" data-id="{{ $semestre->id_semestre }}">
              ...
              <div class="semestre-body">
                ...
                <div class="semestre-panel-actions">
                  <a href="{{ route('coordinador.tlahuitoltepec.panel', $semestre->id_semestre) }}" class="semestre-panel-btn semestre-panel-btn--extra">Actividades extraescolares</a>
                  <a href="{{ route('coordinador.tlahuitoltepec.panel.complementarias', $semestre->id_semestre) }}" class="semestre-panel-btn semestre-panel-btn--comp">Actividades complementarias</a>
                </div>
              </div>
            </div>
          </div>
