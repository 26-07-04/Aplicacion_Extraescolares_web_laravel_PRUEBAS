...
<head>
  ...
  <title>Complementarias — Panel Coordinador - Tlahuitoltepec - {{ $semestre->nombre ?? '' }}</title>
    ...
    <div class="sidebar-menu">
      <ul>
        ...
        <li style="margin-top:12px; padding-top:12px; border-top:1px solid rgba(255,255,255,0.15);">
          <a href="{{ route('coordinador.tlahuitoltepec.panel', $semestre->id_semestre ?? $semestre->id) }}" style="font-size:0.9rem;">
            <i class="fas fa-exchange-alt"></i> Ir a Extraescolares
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="main-content">
    ...
    <div class="content-wrapper">
      ...
      @if(request()->get('show') === 'estudiantes')
        @include('coordinador.tlahuitoltepec.complementarias.estudiantes_table')
      @endif

      @if(request()->get('show') === 'constancias')
        @include('coordinador.tlahuitoltepec.complementarias.constancias_table')
      @endif
      ...
      @if(request()->get('show') === 'informe')
        @php
            ...
            $id_unidad_informe = 3;
        @endphp
        @include('coordinador.tlahuitoltepec.complementarias.informe_actividad', [
      ...
      @if(in_array(request()->get('show'), ['formatos', 'resultados'], true))
        @include('coordinador.valle_de_etla.formatos', [
            'firmasUnidadKey' => 'tlahuitoltepec',
            'formatosPrintRoute' => 'coordinador.tlahuitoltepec.formatos.print.complementarias',
            'formatosLugarBase' => 'Santiago Suchilquitongo',
        ])
      @endif
