...
<head>
  ...
  <title>Panel Coordinador - Valle de Etla - {{ $semestre->nombre ?? '' }}</title>
  ...
  <div class="main-content">
    <!-- Top Navbar -->
      ...
      <div class="user-menu" style="position:relative; display:flex; align-items:center; gap:24px; margin-left:auto;">
        <a href="{{ route('coordinador.semestres.valle') }}" class="btn-regresar-header" title="Regresar a Semestres cursados" style="display:inline-flex; align-items:center; justify-content:center; gap:8px; background:#1B396A; color:#fff; padding:6px 10px; min-width:36px; border-radius:6px; text-decoration:none;">
    ...
    <div class="content-wrapper">
      ...
      <div class="unidad-header">
        Tecnológico Nacional de México - Unidad Académica Valle de Etla
      </div>
      ...
      <div class="welcome-section">
        ...
        <p>Desde este panel podrás gestionar estudiantes, constancias, informes y generar formatos de impresión para el semestre seleccionado.</p>
      </div>
      ...
      @if(request()->get('show') === 'estudiantes')
        @include('coordinador.valle_de_etla.estudiantes_table')
      @endif
    ...
    <footer class="site-footer">
      <div class="footer-container">
        <div class="footer-text">
          <h3>Dirección</h3>
          <p>Abasolo S/N, Barrio del Agua Buena<br>68230 Oax.</p>
          <h3>Contacto</h3>
          <p>Teléfono: <a href="tel:+529515284660" style="color:#fff;text-decoration:none">+52 951 528 4660</a></p>
          <h3>Preguntar por Whatsapp</h3>
          <p>
            <a href="https://wa.me/529515284660" target="_blank" rel="noopener noreferrer">
        ...
        <div class="footer-map">
          <iframe
            src="https://maps.google.com/maps?q=Abasolo%20S%2FN%2C%20Barrio%20del%20Agua%20Buena%2C%2068230%20Oax.&output=embed"
            width="100%" height="280" style="border:0;border-radius:8px;" allowfullscreen="" loading="lazy"></iframe>
        </div>
      </div>
      <div class="footer-copyright">
        <p>© 2025 Tecnológico Nacional de México - Valle de Etla. Todos los derechos reservados.</p>
      </div>
    </footer>
  </div>
          ...
          try {
            ...
            if (!mapped.length) {
              ...
              fetch('/coordinador/actividades/' + actividadSeleccionada.id + '/estudiantes/check-duplicates', {
                ...
                body: JSON.stringify({ numeroControles: numeroControles, id_semestre: __currentSemestreId })
