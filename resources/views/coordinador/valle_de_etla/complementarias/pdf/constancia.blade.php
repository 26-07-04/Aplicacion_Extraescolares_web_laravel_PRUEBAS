...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Tabla real: DomPDF alinea mal los display:table en divs */
        table.firmas-table {
            width: 100%;
        ...
        /* Misma altura que "Vo. Bo." en la columna derecha para alinear las líneas */
        .firma-vobo-spacer {
            font-size: 9pt;
            font-weight: bold;
...
<body>
    ...
    @php
        ...
        // Respaldo si el año sigue en cifras (intl ausente o fallido)
