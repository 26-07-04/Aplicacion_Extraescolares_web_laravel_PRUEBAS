<!-- Partial: Constancias — panel Actividades Complementarias (Valle de Etla) -->
<style>
...
<script>
                    ...
                    <form id="formEvaluacion">
                        ...
                        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 4px solid #17a2b8;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr; gap: 15px;">
                                ...
                                <div>
                                    <label style="display: block; font-weight: 600; color: #333; margin-bottom: 6px; font-size: 0.95em;">
                                        <i class="fas fa-user-shield"></i> Nombre del Jefe(a) del Depto. de Actividades Complementarias: <span style="color: #dc3545;">*</span>
                                    </label>
    ...
    function guardarEvaluacion(estudiante) {
        ...
        .then(data => {
            if (data.success) {
                ...
                const urlPDF = `/coordinador/valle-de-etla/complementarias/constancia/${data.id_evaluacion}/pdf?id_documento=${documentoMembrete}`;
    ...
    function descargarConstancia(idEvaluacion) {
        ...
        const urlPDF = `/coordinador/valle-de-etla/complementarias/constancia/${idEvaluacion}/pdf?id_documento=${documentoMembrete}`;
        window.location.href = urlPDF;
    }
