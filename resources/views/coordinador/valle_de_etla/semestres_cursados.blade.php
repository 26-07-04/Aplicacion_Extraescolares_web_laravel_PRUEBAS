...
<head>
  ...
  <title>Semestres Cursados - Unidad Académica Valle de Etla</title>
...
<body>
  ...
  <div class="title-bar">
    <h1> Semestres Cursados - Unidad Académica Valle de Etla</h1>
  ...
  <div class="main-container">
    <div class="semestres-container">
      <div class="semestres-header">
        <h2>Historial de Semestres - Valle de Etla</h2>
        <p class="descripcion-seccion">
          Aquí se muestran los semestres disponibles creados por el Administrador para la Unidad Académica Valle de Etla.
        </p>
      </div>
