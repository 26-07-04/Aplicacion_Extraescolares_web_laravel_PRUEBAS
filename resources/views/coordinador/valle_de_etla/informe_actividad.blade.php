...
<title>Informe de Actividades - Valle de Etla</title>
</head>
...
<div class="titulo-principal">
  <h1>Informe de Actividades - Valle de Etla</h1>
  <p>Sistema de generación de informes para la unidad Valle de Etla</p>
</div>
...
<div class="seccion-contenedor">
  ...
  <div class="seccion activa" id="seccion1">
    <h2 class="seccion-titulo">Documento Base Membretado - Valle de Etla</h2>
    <input type="hidden"
      id="id_semestre"
      value="{{ $id_semestre ?? ($semestreActual->id_semestre ?? '') }}">
    <input type="hidden" id="id_unidad" value="4">
...
async function generarPDF() {
  ...
  try {
    ...
    bloques.forEach((bloque, index) => {
      ...
      doc.setFontSize(11);
      doc.text("Unidad Valle de Etla", doc.internal.pageSize.width/2, y, {align: "center"}); y += 15;
    ...
    let nombrePDF = tituloInforme ? tituloInforme : 'informe_actividades_valle_etla';
    ...
    // Usa la URL generada por Laravel para evitar problemas de rutas
    const guardarUrl = "{{ route('informe_valle_de_etla.guardar') }}";
    ...
    doc.save("informe_actividades_valle_etla.pdf");
