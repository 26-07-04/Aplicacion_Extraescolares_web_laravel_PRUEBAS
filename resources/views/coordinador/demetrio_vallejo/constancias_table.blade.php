...
<script>
    ...
    function guardarEvaluacion(estudiante) {
        ...
        if (!jefeExtraescolares) {
            alert('Por favor, ingrese el nombre del Jefe del Departamento de Actividades Extraescolares.');
        ...
        .then(data => {
            if (data.success) {
                ...
                const urlPDF = `/coordinador/demetrio-vallejo/constancia/${data.id_evaluacion}/pdf?id_documento=${documentoMembrete}`;
...
@include('coordinador.partials.constancia_extraescolar_cargos_editable', ['constanciaCargosStorageKey' => 'constancia_cargos_extraescolar_demetrio'])
