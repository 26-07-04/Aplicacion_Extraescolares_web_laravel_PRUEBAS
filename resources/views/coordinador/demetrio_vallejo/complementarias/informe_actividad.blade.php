...
<div class="seccion-contenedor">
  ...
  <div class="seccion activa" id="seccion1">
    ...
    <input type="hidden" id="id_unidad" value="{{ $id_unidad ?? 2 }}">
  ...
  <div class="seccion" id="seccion4">
    ...
    <div class="grupo-formulario informe-lugar-fecha-grupo">
      ...
      <input type="text" id="lugarFecha" class="input-estilo" placeholder="Ej: Demetrio Vallejo, a los 27 días del mes de mayo de 2025">
...
async function generarPDF() {
  ...
  try {
    ...
    fetch(@json(route('demetrio.informe.guardar')), {
      method: 'POST',
      headers,
