...
<head>
  ...
  <title>Semestres Cursados - Unidad Académica Demetrio Vallejo</title>
...
<body>
  ...
  <div class="title-bar">
    <h1> Semestres Cursados - Unidad Académica Demetrio Vallejo</h1>
  ...
  <div class="main-container">
    <div class="semestres-container">
      <div class="semestres-header">
        <h2>Historial de Semestres - Demetrio Vallejo</h2>
        <p class="descripcion-seccion">
          Aquí se muestran los semestres disponibles creados por el Administrador para la Unidad Académica Demetrio Vallejo.
        </p>
      </div>
            ...
            <div class="semestre-card" data-id="{{ $semestre->id_semestre }}">
              ...
              <div class="semestre-body">
                ...
                <div class="semestre-panel-actions">
                  <a href="{{ route('coordinador.demetrio.panel', $semestre->id_semestre) }}" class="semestre-panel-btn semestre-panel-btn--extra">Actividades extraescolares</a>
                  <a href="{{ route('coordinador.demetrio.panel.complementarias', $semestre->id_semestre) }}" class="semestre-panel-btn semestre-panel-btn--comp">Actividades complementarias</a>
                </div>
              </div>
            </div>
          </div>
