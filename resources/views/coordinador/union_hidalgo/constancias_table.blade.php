...
<script>
                    ...
                    <form id="formEvaluacion">
                        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 4px solid #1a3461;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr; gap: 15px;">
                                ...
                                <div>
                                    <label style="display: block; font-weight: 600; color: #333; margin-bottom: 6px; font-size: 0.95em;">(2) Actividad Cultural y/o Deportiva:</label>
    ...
    function guardarEvaluacion(estudiante) {
        ...
        .then(data => {
            if (data.success) {
                ...
                const urlPDF = `/coordinador/union-hidalgo/constancia/${data.id_evaluacion}/pdf?id_documento=${documentoMembrete}`;
    ...
    function descargarConstancia(idEvaluacion) {
        ...
        const urlPDF = `/coordinador/union-hidalgo/constancia/${idEvaluacion}/pdf?id_documento=${documentoMembrete}`;
        window.location.href = urlPDF;
    }
...
@include('coordinador.partials.constancia_extraescolar_cargos_editable', ['constanciaCargosStorageKey' => 'constancia_cargos_extraescolar_union'])
