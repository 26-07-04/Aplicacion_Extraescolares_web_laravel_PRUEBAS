...
<head>
  ...
  <title>Complementarias — Panel Coordinador - Unión Hidalgo - {{ $semestre->nombre ?? '' }}</title>
  ...
  <div class="main-content">
    ...
    <div class="content-wrapper">
      ...
      @if(request()->get('show') === 'estudiantes')
        @include('coordinador.union_hidalgo.complementarias.estudiantes_table')
      @endif

      @if(request()->get('show') === 'constancias')
        @include('coordinador.union_hidalgo.complementarias.constancias_table')
      @endif
      ...
      @if(request()->get('show') === 'informe')
        @php
            ...
            $id_unidad_informe = 1;
        @endphp
        @include('coordinador.union_hidalgo.complementarias.informe_actividad', [
      ...
      @if(in_array(request()->get('show'), ['formatos', 'resultados'], true))
        @include('coordinador.valle_de_etla.formatos', [
            ...
            'formatosPrintRoute' => 'coordinador.union_hidalgo.formatos.print.complementarias',
