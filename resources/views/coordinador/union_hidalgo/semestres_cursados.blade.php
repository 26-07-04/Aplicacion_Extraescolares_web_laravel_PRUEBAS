...
<head>
  ...
  <title>Semestres Cursados - Unidad Académica Unión Hidalgo</title>
...
<body>
  ...
  <div class="title-bar">
    <h1> Semestres Cursados - Unidad Académica Unión Hidalgo</h1>
  ...
  <div class="main-container">
    <div class="semestres-container">
      <div class="semestres-header">
        <h2>Historial de Semestres - Unión Hidalgo</h2>
        <p class="descripcion-seccion">
          Aquí se muestran los semestres disponibles creados por el Administrador para la Unidad Académica Unión Hidalgo.
        </p>
      </div>
            ...
            <div class="semestre-card" data-id="{{ $semestre->id_semestre }}">
              ...
              <div class="semestre-body">
                ...
                <div class="semestre-panel-actions">
                  <a href="{{ route('coordinador.union.panel', ['id' => $semestre->id_semestre]) }}" class="semestre-panel-btn semestre-panel-btn--extra">Actividades extraescolares</a>
                  <a href="{{ route('coordinador.union.panel.complementarias', ['id' => $semestre->id_semestre]) }}" class="semestre-panel-btn semestre-panel-btn--comp">Actividades complementarias</a>
                </div>
              </div>
            </div>
          </div>
