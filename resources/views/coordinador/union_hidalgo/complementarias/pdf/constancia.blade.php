        ...
        <div class="firmas">
            <div class="firmas-columns">
                ...
                <div class="firma-der">
                    <div class="etiqueta-firma">&nbsp;</div>
                    <div class="firma-linea"></div>
                    <div class="firma-nombre"><div class="vobo" style="margin-top:6px; margin-bottom:6px;"><strong>Vo. Bo.</strong></div><strong>{{ $evaluacion->jefe_extraescolares ?? '_______________________________' }}</strong><br><strong style="font-size: 8pt; color: #000;">JEFE DEL DEPARTAMENTO DE ACTIVIDADES COMPLEMENTARIAS</strong></div>
                </div>
            </div>
        </div>
