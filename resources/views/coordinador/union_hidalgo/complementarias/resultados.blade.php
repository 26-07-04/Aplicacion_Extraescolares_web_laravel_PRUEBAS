...
<div class="resultados-container">
    ...
    <div class="resultados-header">
        <div class="resultados-header-content">
            ...
            <p>
                <i class="fas fa-building"></i> {{ $unidad ?? 'Unidad Académica Unión Hidalgo' }}
                | 
...
<script>
    ...
    function abrirImpresion(tipo) {
        ...
        const baseUrl = `{{ route('coordinador.union_hidalgo.resultados.print.complementarias', ['id' => '__ID__']) }}`.replace('__ID__', semestreId);
