  ...
  <script>
    (function(){
      ...
      window.ActUH = {
        ...
        unidadId: resolveUnidadId(unidadServer ?? qUnidad) ?? 2,
...
<body>
  ...
  <!-- Configuración para actividadesDV.js (NO tocar diseño) -->
  <script>
    window.ActDV = {
      rutas: {
        list: "{{ route('administrador.actividades.index') }}",
        ...
        detail: "{{ url('administrador/D_actividades_DV') }}",
      },
      unidadId: 2,
  ...
  <script>
    ...
    if (!window.ActDV) {
      window.ActDV = {
        ...
        unidadId: @json($unidad->id_unidad ?? request()->query('id_unidad') ?? 2),
      ...
      window.ActDV.rutas = window.ActDV.rutas || {
        list: "{{ route('administrador.actividades.index') }}",
        store: "{{ route('administrador.actividades.store') }}",
        showBase: "{{ url('administrador/actividades') }}",
        detail: "{{ url('administrador/vista_previa_U/D_actividades_DV') }}"
      };
      window.ActDV.assetBase = window.ActDV.assetBase || "{{ asset('') }}";
