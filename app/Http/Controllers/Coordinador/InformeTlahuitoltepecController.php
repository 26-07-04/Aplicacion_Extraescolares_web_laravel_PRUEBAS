...
class InformeTlahuitoltepecController extends Controller
{
	/**
	...
	public function index(Request $request)
	{
		...
		$informes = [];
		$id_unidad = 3; // Forzar id_unidad=3 para Tlahuitoltepec
		...
		return view('coordinador.tlahuitoltepec.informe_actividad', [
	...
	{
		$datos = $request->all();
		$pdf = FacadePdf::loadView('coordinador.pdf_tlahuitoltepec', $datos);
