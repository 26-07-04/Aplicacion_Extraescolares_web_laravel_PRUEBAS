...
class InformeValleDeEtlaController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		$informes = [];
		$id_unidad = 4; // Forzar id_unidad=4 para Valle de Etla
		...
		return view('coordinador.valle_de_etla.informe_actividad', [
	 ...
	 */
	   ...
	   {
		   $datos = $request->all();
		   $pdf = FacadePdf::loadView('coordinador.pdf_valle_etla', $datos);
		   return $pdf->download('informe_eventos_valle_etla.pdf');
	   }
}
