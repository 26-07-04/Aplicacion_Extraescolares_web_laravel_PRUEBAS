...
class PanelTlahuitoltepecController extends Controller
{
    ...
    {
        return ['Tlahuitoltepec', 'Tlahui', 'TLAHUI'];
    }
    ...
    public function actualizarEstudiante($id, Request $request)
    {
        ...
        try {
            ...
            $validated = $request->validate([
                ...
                'numero_control' => \App\Models\Estudiante::reglasNumeroControlEnActividad((int) $estudiante->id_actividad, (int) $estudiante->id_alumno),
