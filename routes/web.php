...
Route::middleware(['auth'])->get('/informes/{informe}/archivo', function (\App\Models\Informe $informe) {
    $rel = ltrim(str_replace('storage/', '', (string) $informe->archivo), '/');
    if ($rel === '') {
        abort(404);
    }
